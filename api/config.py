...
CONFIGURATION = {
    ...
    "localauth": "config.DevWithLocalAuthServerConfig",
...
class DevWithLocalAuthServerConfig(Config):
    TESTING = False,
    DEBUG = True
    ...
    '''
    # JWT_OIDC Settings
    JWT_OIDC_WELL_KNOWN_CONFIG = os.getenv('LOCALAUTH_JWT_OIDC_WELL_KNOWN_CONFIG')
    JWT_OIDC_ALGORITHMS = os.getenv('LOCALAUTH_JWT_OIDC_ALGORITHMS')
    JWT_OIDC_JWKS_URI = os.getenv('LOCALAUTH_JWT_OIDC_JWKS_URI')
    JWT_OIDC_ISSUER = os.getenv('LOCALAUTH_JWT_OIDC_ISSUER')
    JWT_OIDC_AUDIENCE = os.getenv('LOCALAUTH_JWT_OIDC_AUDIENCE')
    JWT_OIDC_CLIENT_SECRET = os.getenv('LOCALAUTH_JWT_OIDC_CLIENT_SECRET')
    JWT_OIDC_CACHING_ENABLED = os.getenv('LOCALAUTH_JWT_OIDC_CACHING_ENABLED')
    try:
        JWT_OIDC_JWKS_CACHE_TIMEOUT = int(os.getenv('JWT_OIDC_JWKS_CACHE_TIMEOUT'))
    except:
        JWT_OIDC_JWKS_CACHE_TIMEOUT = 300
