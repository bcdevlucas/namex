...
api = Namespace('authSampleWithValidation', description='Roles and Validations Example')
...
class AuthorizedCollectionResourceWithValidation(ResourceWithAuth):
    _model = FakeModel
...
class AuthorizedResourceWithValidation(ResourceWithAuth):
    _model = FakeModel
